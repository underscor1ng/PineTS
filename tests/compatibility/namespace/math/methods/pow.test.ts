...
describe('MATH Namespace - POW Method', () => {
    it('should calculate POW correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'pow.expect.json');
