...
describe('MATH Namespace - LOG Method', () => {
    it('should calculate LOG correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'log.expect.json');
