...
describe('MATH Namespace - SQRT Method', () => {
    it('should calculate SQRT correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'sqrt.expect.json');
