...
describe('TA Namespace - EMA Method', () => {
    it('should calculate EMA correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'ema.expect.json');
