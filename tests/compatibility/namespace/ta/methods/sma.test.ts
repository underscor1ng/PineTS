...
describe('TA Namespace - SMA Method', () => {
    it('should calculate SMA correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'sma.expect.json');
