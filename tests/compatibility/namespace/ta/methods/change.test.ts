...
describe('TA Namespace - CHANGE Method', () => {
    it('should calculate CHANGE correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'change.expect.json');
