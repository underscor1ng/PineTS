...
describe('TA Namespace - PIVOTLOW Method', () => {
    it('should calculate PIVOTLOW correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'pivotlow.expect.json');
