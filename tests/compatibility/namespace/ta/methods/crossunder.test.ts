...
describe('TA Namespace - CROSSUNDER Method', () => {
    it('should calculate CROSSUNDER correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'crossunder.expect.json');
