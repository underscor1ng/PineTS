...
describe('TA Namespace - DEV Method', () => {
    it('should calculate DEV correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'dev.expect.json');
