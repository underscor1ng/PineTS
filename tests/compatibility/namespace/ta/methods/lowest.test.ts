...
describe('TA Namespace - LOWEST Method', () => {
    it('should calculate LOWEST correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'lowest.expect.json');
