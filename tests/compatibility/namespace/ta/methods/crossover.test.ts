...
describe('TA Namespace - CROSSOVER Method', () => {
    it('should calculate CROSSOVER correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'crossover.expect.json');
