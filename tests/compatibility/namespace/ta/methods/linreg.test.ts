...
describe('TA Namespace - LINREG Method', () => {
    it('should calculate LINREG correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'linreg.expect.json');
