...
describe('TA Namespace - ROC Method', () => {
    it('should calculate ROC correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'roc.expect.json');
