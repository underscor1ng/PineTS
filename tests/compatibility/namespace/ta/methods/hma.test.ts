...
describe('TA Namespace - HMA Method', () => {
    it('should calculate HMA correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'hma.expect.json');
