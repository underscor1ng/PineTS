...
describe('TA Namespace - RMA Method', () => {
    it('should calculate RMA correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'rma.expect.json');
