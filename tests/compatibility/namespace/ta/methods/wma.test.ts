...
describe('TA Namespace - WMA Method', () => {
    it('should calculate WMA correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'wma.expect.json');
