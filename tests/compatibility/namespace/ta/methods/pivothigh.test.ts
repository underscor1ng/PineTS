...
describe('TA Namespace - PIVOTHIGH Method', () => {
    it('should calculate PIVOTHIGH correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'pivothigh.expect.json');
