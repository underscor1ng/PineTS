...
describe('TA Namespace - RSI Method', () => {
    it('should calculate RSI correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'rsi.expect.json');
