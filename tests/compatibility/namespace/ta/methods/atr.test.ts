...
describe('TA Namespace - ATR Method', () => {
    it('should calculate ATR correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'atr.expect.json');
