...
describe('TA Namespace - MEDIAN Method', () => {
    it('should calculate MEDIAN correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'median.expect.json');
