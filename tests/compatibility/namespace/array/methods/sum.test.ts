...
describe('ARRAY Namespace - SUM Method', () => {
    it('should calculate SUM correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'sum.expect.json');
