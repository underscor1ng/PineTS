...
describe('ARRAY Namespace - MAX Method', () => {
    it('should calculate MAX correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'max.expect.json');
