...
describe('ARRAY Namespace - INDEXOF Method', () => {
    it('should calculate INDEXOF correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'indexof.expect.json');
