...
describe('ARRAY Namespace - STDEV Method', () => {
    it('should calculate STDEV correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'stdev.expect.json');
