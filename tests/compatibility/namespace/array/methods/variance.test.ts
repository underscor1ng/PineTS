...
describe('ARRAY Namespace - VARIANCE Method', () => {
    it('should calculate VARIANCE correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'variance.expect.json');
