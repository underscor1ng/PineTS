...
describe('ARRAY Namespace - PUSH Method', () => {
    it('should calculate PUSH correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'push.expect.json');
