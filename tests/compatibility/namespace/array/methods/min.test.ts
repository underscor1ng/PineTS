...
describe('ARRAY Namespace - MIN Method', () => {
    it('should calculate MIN correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'min.expect.json');
