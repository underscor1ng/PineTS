...
describe('ARRAY Namespace - LASTINDEXOF Method', () => {
    it('should calculate LASTINDEXOF correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'lastindexof.expect.json');
