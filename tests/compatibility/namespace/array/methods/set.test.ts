...
describe('ARRAY Namespace - SET Method', () => {
    it('should calculate SET correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'set.expect.json');
