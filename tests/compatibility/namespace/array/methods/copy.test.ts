...
describe('ARRAY Namespace - COPY Method', () => {
    it('should calculate COPY correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'copy.expect.json');
