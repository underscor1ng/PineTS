...
describe('ARRAY Namespace - SORT_INDICES Method', () => {
    it('should calculate SORT_INDICES correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'sort_indices.expect.json');
