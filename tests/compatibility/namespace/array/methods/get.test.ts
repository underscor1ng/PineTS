...
describe('ARRAY Namespace - GET Method', () => {
    it('should calculate GET correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'get.expect.json');
