...
describe('ARRAY Namespace - RANGE Method', () => {
    it('should calculate RANGE correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'range.expect.json');
