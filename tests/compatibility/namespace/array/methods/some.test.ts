...
describe('ARRAY Namespace - SOME Method', () => {
    it('should calculate SOME correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'some.expect.json');
