...
describe('ARRAY Namespace - SIZE Method', () => {
    it('should calculate SIZE correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'size.expect.json');
