...
describe('ARRAY Namespace - FILL Method', () => {
    it('should calculate FILL correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'fill.expect.json');
