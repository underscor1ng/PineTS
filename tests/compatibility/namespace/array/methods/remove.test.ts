...
describe('ARRAY Namespace - REMOVE Method', () => {
    it('should calculate REMOVE correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'remove.expect.json');
