...
describe('ARRAY Namespace - COVARIANCE Method', () => {
    it('should calculate COVARIANCE correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'covariance.expect.json');
