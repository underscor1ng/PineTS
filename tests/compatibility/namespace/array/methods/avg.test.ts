...
describe('ARRAY Namespace - AVG Method', () => {
    it('should calculate AVG correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'avg.expect.json');
