...
describe('ARRAY Namespace - POP Method', () => {
    it('should calculate POP correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'pop.expect.json');
