...
describe('ARRAY Namespace - LAST Method', () => {
    it('should calculate LAST correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'last.expect.json');
