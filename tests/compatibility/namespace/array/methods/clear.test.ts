...
describe('ARRAY Namespace - CLEAR Method', () => {
    it('should calculate CLEAR correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'clear.expect.json');
