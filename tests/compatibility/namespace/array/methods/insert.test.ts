...
describe('ARRAY Namespace - INSERT Method', () => {
    it('should calculate INSERT correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'insert.expect.json');
