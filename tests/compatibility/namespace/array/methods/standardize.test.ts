...
describe('ARRAY Namespace - STANDARDIZE Method', () => {
    it('should calculate STANDARDIZE correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'standardize.expect.json');
