...
describe('ARRAY Namespace', () => {
    ...
    it('CLEAR regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/clear.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('CONCAT regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/concat.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('COPY regression test', async () => {
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/copy.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('COVARIANCE regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/covariance.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('EVERY regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/every.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('FILL regression test', async () => {
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/fill.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('FIRST regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/first.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('GET regression test', async () => {
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/get.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('INCLUDES regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/includes.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('INDEXOF regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/indexof.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('INSERT regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/insert.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('JOIN regression test', async () => {
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/join.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('LAST regression test', async () => {
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/last.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('LASTINDEXOF regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/lastindexof.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('NEW regression test', async () => {
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/new.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('POP regression test', async () => {
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/pop.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('PUSH regression test', async () => {
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/push.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('RANGE regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/range.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('REMOVE regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/remove.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('SET regression test', async () => {
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/set.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('SHIFT regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/shift.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('SIZE regression test', async () => {
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/size.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('SLICE regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/slice.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('SOME regression test', async () => {
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/some.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('SORT_INDICES regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/sort_indices.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('STANDARDIZE regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/standardize.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
    ...
    it('UNSHIFT regression test', async () => {
        const pineTS = new PineTS(Provider.Mock, 'BTCUSDC', 'D', null, new Date('2025-01-01').getTime(), new Date('2025-11-20').getTime());
        ...
        // Load expected data from JSON file using custom deserializer
        const expectFilePath = path.join(__dirname, 'data/unshift.expect.json');
        const expectedData = deserialize(fs.readFileSync(expectFilePath, 'utf-8'));
