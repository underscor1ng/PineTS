...
describe('ARRAY Namespace - CONCAT Method', () => {
    it('should calculate CONCAT correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'concat.expect.json');
