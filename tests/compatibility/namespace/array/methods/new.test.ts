...
describe('ARRAY Namespace - NEW Method', () => {
    it('should calculate NEW correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'new.expect.json');
