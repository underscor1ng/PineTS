...
describe('ARRAY Namespace - FIRST Method', () => {
    it('should calculate FIRST correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'first.expect.json');
