...
describe('ARRAY Namespace - EVERY Method', () => {
    it('should calculate EVERY correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'every.expect.json');
