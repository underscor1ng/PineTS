...
describe('ARRAY Namespace - JOIN Method', () => {
    it('should calculate JOIN correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'join.expect.json');
